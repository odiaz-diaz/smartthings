 ...
 */
metadata {
   definition (name: "Virtual Thermostat Switch", namespace: "otros", author: "odiaz", runLocally: false, mnmn: "SmartThings", vid: "generic-switch", ocfDeviceType:"oic.d.thermostat" ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
    }
