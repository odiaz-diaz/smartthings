 ...
 */
metadata {
   definition (name: "Virtual Control Switch", namespace: "otros", author: "odiaz", runLocally: false, mnmn: "SmartThings", vid: "generic-switch", ocfDeviceType:"x.com.st.d.remotecontroller" ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
    }
