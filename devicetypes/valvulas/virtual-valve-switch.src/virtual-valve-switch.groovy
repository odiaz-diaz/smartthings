 ...
 */
metadata {
   definition (name: "Virtual Valve Switch", namespace: "valvulas", author: "odiaz", runLocally: false, mnmn: "SmartThings", vid: "generic-switch", ocfDeviceType:"oic.d.watervalve" ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
    }
