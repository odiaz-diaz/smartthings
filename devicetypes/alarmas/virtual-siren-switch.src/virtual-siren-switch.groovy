 ...
 */
metadata {
   definition (name: "Virtual Siren Switch", namespace: "alarmas", author: "odiaz", runLocally: false, mnmn: "SmartThings", vid: "generic-switch", ocfDeviceType:"x.com.st.d.siren" ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
    }
