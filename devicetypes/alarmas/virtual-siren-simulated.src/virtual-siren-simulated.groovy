 ...
 */
metadata {
   definition (name: "Virtual Siren Simulated", namespace: "alarmas", author: "odiaz", runLocally: false, mnmn: "SmartThings", vid: "generic-switch", ocfDeviceType:"x.com.st.d.siren" ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
        capability "Alarm"
