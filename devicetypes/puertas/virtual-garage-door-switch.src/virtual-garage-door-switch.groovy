 ...
 */
metadata {
   definition (name: "Virtual Garage Door Switch", namespace: "puertas", author: "odiaz", runLocally: false, mnmn: "SmartThings", vid: "generic-switch", ocfDeviceType:"oic.d.garagedoor" ) {
        capability "Actuator"
        capability "Sensor"
        capability "Switch"
    }
